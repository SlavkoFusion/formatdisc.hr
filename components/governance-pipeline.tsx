    ...
    <div className="w-full py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <Badge className="mb-4 bg-[#76B900]/10 text-[#76B900] hover:bg-[#76B900]/20">
            5-Phase Governance Pipeline
          </Badge>
          <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-[#76B900] to-green-400 bg-clip-text text-transparent">
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              href="#simulation"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#76B900] hover:bg-[#76B900]/90 text-white rounded-lg font-semibold transition-all"
            >
            ...
            <a
              href="#pricing"
              className="inline-flex items-center gap-2 px-6 py-3 bg-background border-2 border-[#76B900] text-[#76B900] hover:bg-[#76B900]/10 rounded-lg font-semibold transition-all"
            >
              View Pricing
            </a>
          </div>
